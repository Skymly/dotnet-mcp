...
/// MSBuildWorkspace has no public API for .slnf (roslyn#73105).
/// </summary>
public static class SlnfParser
{
    ...
    /// <summary>
    /// Resolves absolute project paths listed in the filter, relative to the .slnf directory
    /// (same convention as VS: paths in the filter are relative to the solution / filter folder).
    /// </summary>
    public static IReadOnlyList<string> ResolveProjectPaths(string slnfPath, SlnfDocument? document = null)
    {
        ...
        // Projects in .slnf are relative to the solution file's directory.
